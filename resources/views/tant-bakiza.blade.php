...
<head>
    ...
    <title>Tant Bakiza - AdvFood</title>
...
<body class="font-sans">
    <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto space-y-8">
            ...
            <div class="text-center relative">
                ...
                <p id="subtitle" class="text-gray-600 text-lg">Tant Bakiza Restaurant</p>
                <div class="mt-4">
                    <span class="inline-block bg-purple-100 text-purple-700 px-4 py-1.5 rounded-full text-sm font-semibold">
                        <span id="restaurant-count">1</span> <span id="restaurants-text">Restaurant Available</span>
                    </span>
                </div>
            </div>
    ...
    <script>
        const translations = {
            en: {
                subtitle: 'Tant Bakiza Restaurant',
                restaurantsText: 'Restaurant Available',
                timeUnit: 'min',
