...
const form = useForm({
    restaurant_id: props.menuItem.restaurant_id,
    ...
    preparation_time: props.menuItem.preparation_time || 15,
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">تعديل المنتج</h1>
                                    <p class="text-gray-600 dark:text-gray-400">تحديث معلومات {{ menuItem.name }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="hidden md:block">
                            <div class="rounded-xl bg-gradient-to-r from-green-500 to-emerald-500 p-4 text-white shadow-lg">
                                ...
                                <div v-else class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <div class="text-sm font-medium">المطعم</div>
                                        <div class="text-lg font-bold">{{ selectedRestaurant?.name || 'غير محدد' }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        ...
                        <div class="lg:col-span-2">
                            <div class="rounded-2xl bg-white p-8 shadow-xl dark:bg-gray-800">
                                <div class="mb-8">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400">تحديث التفاصيل الأساسية للمنتج</p>
                                </div>
                                ...
                                <form @submit.prevent="submit" class="space-y-6">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <!-- Current Image -->
                                            <div v-else-if="!form.image && menuItem.image" class="relative">
                                                <img
                                                ...
                                                <div class="absolute top-2 left-2">
                                                    <span class="inline-flex items-center rounded-full bg-blue-500 px-3 py-1 text-xs font-medium text-white shadow-sm">
                                                        الصورة الحالية
                                                    </span>
                                                </div>
                                            </div>
                                                    ...
                                                    >
                                                        <div class="flex flex-col items-center justify-center space-y-2">
                                                            ...
                                                            <div class="text-sm text-gray-600 dark:text-gray-400">
                                                                <span class="font-medium text-blue-600 hover:text-blue-500">{{ form.image || menuItem.image ? 'تغيير الصورة' : 'اضغط لاختيار صورة' }}</span>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="rounded-2xl bg-white p-6 shadow-xl dark:bg-gray-800">
                                <h3 class="mb-4 font-semibold text-gray-900 dark:text-white">القيم الحالية</h3>
                                <div class="space-y-4">
                                    <div class="flex items-center justify-between">
                                        <span class="text-sm text-gray-600 dark:text-gray-400">المطعم</span>
                                        <span class="text-sm font-medium text-gray-900 dark:text-white">{{ selectedRestaurant?.name || 'غير محدد' }}</span>
                                    </div>
                                    <div class="flex items-center justify-between">
                                        <span class="text-sm text-gray-600 dark:text-gray-400">السعر الحالي</span>
                                        <span class="text-sm font-medium text-green-600">{{ menuItem.price }} ر.س</span>
                                    </div>
                                    <div class="flex items-center justify-between">
                                        <span class="text-sm text-gray-600 dark:text-gray-400">الحالة</span>
                                        <span :class="['text-sm font-medium', menuItem.is_available ? 'text-green-600' : 'text-red-600']">
